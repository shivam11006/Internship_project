...
function DashboardLawyer() {
  ...
  // Mock New Case Requests
  const [newRequests, setNewRequests] = useState([
    {
      id: 101,
      title: 'Property Dispute Assistance',
      description: 'Need legal representation for a land boundary dispute in rural district.',
      location: 'Lucknow, UP',
      date: '2025-01-02',
      matchScore: 95
    },
    {
      ...
      description: 'Seeking advice on child custody and maintenance rights.',
      location: 'Kanpur, UP',
      date: '2025-01-04',
      matchScore: 88
    }
