...
function DashboardNgo() {
  ...
  const [mockNotifications, setMockNotifications] = useState({
    messages: [
      { id: 1, sender: 'Amit Patel', text: 'Documents for the case are ready.', time: '15m ago' },
      { id: 2, sender: 'Sarah Jenkins', text: 'Can we schedule a call for tomorrow?', time: '2h ago' }
    ],
    appointments: [
      { id: 101, name: 'Ravi Kumar', date: 'Jan 13, 2026', time: '11:00 AM' },
      { id: 102, name: 'Priya Sharma', date: 'Jan 15, 2026', time: '4:00 PM' }
    ]
  });
